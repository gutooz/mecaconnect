...
interface Props {
  // Todas as categorias (income + expense) buscadas pelo Server Component pai
  categories: Category[];
}

export function NovaTransacaoForm({ categories }: Props) {
  ...
  // Filtragem local — sem nova chamada ao Supabase
